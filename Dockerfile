...
# Install Terraform 1.1.5 Arm64
RUN wget https://releases.hashicorp.com/terraform/1.1.5/terraform_1.1.5_linux_arm64.zip && \
  unzip terraform_1.1.5_linux_arm64.zip && \
